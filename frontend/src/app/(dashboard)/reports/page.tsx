    ...
    <div className="min-h-full bg-zinc-950 p-4 sm:p-6 lg:p-8 text-zinc-50 font-sans overflow-y-auto w-full">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 py-5 border-y border-slate-200 dark:border-zinc-800 mb-8 divide-y lg:divide-y-0 lg:divide-x divide-slate-200 dark:divide-zinc-800">
        ...
        >
          ...
          <div className="flex items-center gap-1 text-[11px] text-lime-700 dark:text-lime-400 group-hover:underline mt-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-8 border-b border-slate-200 dark:border-zinc-800/80 mb-8">
