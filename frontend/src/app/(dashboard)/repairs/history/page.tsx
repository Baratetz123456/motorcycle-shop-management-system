                      ...
                      <td className="px-6 py-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-200 transition-colors text-xs font-semibold flex items-center gap-1"
                          >
        ...
        <div className="fixed inset-0 bg-black/75 backdrop-blur-md flex items-center justify-end z-50">
          <div className="bg-zinc-900 border-l border-white/10 w-full max-w-xl h-full flex flex-col shadow-2xl">
            <div className="p-6 border-b border-white/10 bg-zinc-950/80 flex items-center justify-between">
              <div>
                <h3 className="text-xl font-bold text-white">{selectedRecord.customer_name}</h3>
                <p className="text-xs text-cyan-400 font-mono mt-0.5">{selectedRecord.motorcycle_model}</p>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {selectedRecord.past_jobs.map((job) => (
                <div key={job.job_id} className="bg-zinc-950/80 border border-white/10 rounded-2xl p-5 shadow-lg space-y-3">
