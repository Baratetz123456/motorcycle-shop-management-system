...
- **Concise Navigation**: Avoid cluttering the top-level sidebar with primary action pages. Place contextual creation/registration buttons (e.g. "Register New User") as header actions directly on management pages.
...
- **Glassmorphism**: Utilize `bg-zinc-900/60 backdrop-blur-xl` and subtle borders (`border-white/10`) for cards, tables, modals, and headers.
